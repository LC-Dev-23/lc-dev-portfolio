...
const HeroSection = () => {
  return (
    <Section className="flex flex-col-reverse items-center justify-end lg:flex-row lg:justify-center md:gap-5 lg:gap-20 pt-28 pb-20 md:pt-40 lg:py-0">
      <article className='lg:max-w-[30rem] xl:max-w-[41rem] font-normal font-body text-base lg:text-lg'>
        ...
        <h2 className="text-xl md:text-2xl pb-2 font-special text-accentBrightRed dark:drop-shadow-none drop-shadow-md">Web Developer</h2>
