  ...
  return (
    <Section className="py-20 flex flex-col justify-center">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-5 lg:gap-10">
        <article className="text-primaryBlack dark:text-accentSoftGray text-base lg:text-lg font-normal font-body lg:max-w-[30rem] xl:max-w-[50rem] border dark:border-white/[0.2] border-black/[0.2] dark:shadow-none shadow-md rounded-xl p-5 lg:p-10">
          <p>
