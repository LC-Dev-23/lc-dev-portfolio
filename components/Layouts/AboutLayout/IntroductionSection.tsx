        ...
        <Section className="py-20 lg:py-40 flex flex-col justify-center">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-5 lg:gap-10 ">
                <Image className="w-[10rem] lg:w-[15rem] h-auto object-contain dark:drop-shadow-none drop-shadow-md"
                    ...
                    priority={true} />
                <article className='text-primaryBlack dark:text-accentSoftGray lg:max-w-[30rem] xl:max-w-[50rem] border dark:border-white/[0.2] border-black/[0.2] dark:shadow-none shadow-md rounded-xl p-5 lg:p-10'>
