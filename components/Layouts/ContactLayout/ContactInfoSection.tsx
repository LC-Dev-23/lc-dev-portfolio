...
const InformationSection = () => {
  return (
    <Section className="py-20 lg:py-40 flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center text-primaryBlack dark:text-accentSoftGray w-full lg:max-w-[50rem] border dark:border-white/[0.2] border-black/[0.2] shadow-xl rounded-xl p-5 lg:p-10">
        <h1 className="text-center text-xl md:text-3xl font-display font-bold dark:text-primaryWhite">Let&apos;s Build Something Great Together</h1>
        <h3 className="text-center text-base md:text-xl font-special italic">Feel free to contact me for any project inquiries or collaboration opportunities.</h3>
        <ul className="grid grid-col-1 md:grid-cols-2 gap-2 text-sm md:text-lg font-sans py-5 md:py-10 mx-auto">
          ...
          <li><ReusableTooltip triggerContent={<Link className="flex items-center gap-4" href={"https://www.facebook.com/lord.christian.agra.23"} target="_blank"><span className="text-accentBrightRed border dark:border-white/[0.2] border-black/[0.2] shadow-xl rounded-xl p-2"><FaFacebookF /></span><span className="flex flex-col"><span className="text-xs">Facebook:</span><span className="dark:text-primaryWhite text-primaryBlack">facebook.com/<span className="hidden md:block lg:hidden" />lord.christian.agra.23</span></span></Link>} tooltipText="Check out my Facebook profile" /></li>
