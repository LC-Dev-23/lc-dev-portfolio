      ...
      <div className="grid grid-cols-1 grid-rows-3 gap-5 lg:gap-0  lg:grid-cols-3 lg:grid-rows-1 py-5">
        <div className="mx-auto">
          <Image
            ...
            priority={true}
          />
          <li className="flex items-center gap-2"><span className="text-accentBrightRed text-xl"><FaMapMarkerAlt /></span><a href="https://maps.app.goo.gl/wF9G8z9dvMfiUNaMA" target="_blank">Teresa, Rizal, Philippines</a></li>
        </div>
        ...
        <div className="mx-auto">
          ...
          <ul className="text-left">
            <li className="flex items-center gap-2"><span className="text-accentBrightRed text-xl"><FaEnvelope /></span><a href="mailto:lordchristianagra23@gmail.com">lordchristianagra23@gmail.com</a></li>
            <li className="flex items-center gap-2"><span className="text-accentBrightRed text-xl"><FaPhoneAlt /></span><a href="tel:639489214499">+63 948 921 4499</a></li>
            <li></li>
          </ul>
        </div>
      </div>
