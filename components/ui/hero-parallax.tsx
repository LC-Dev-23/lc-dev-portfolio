...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[125rem] md:min-h-[135rem] lg:min-h-[140rem] overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={website.title}
      className="group/product h-[14rem] w-[25rem] md:h-[20rem] md:w-[35rem] xl:h-[25rem] xl:w-[45rem] relative flex-shrink-0"
    >
      <Link
        href={website.link}
